  ...
  return (
    <div className="Container-fluid">
      <Carousel activeIndex={index} onSelect={handleSelect} interval={5000}>
        <Carousel.Item>
          <img className="d-block w-100 " src={headerimg1} alt="First slide" />
          <Carousel.Caption>
            <Row>
              <p>Welcome</p>
        ...
        <Carousel.Item>
          <img className="d-block w-100" src={headerimg3} alt="Second slide" />
          <Carousel.Caption>
            <Row>
              <p>Welcome</p>
        ...
        <Carousel.Item>
          <img className="d-block w-100" src={headerimg5} alt="Third slide" />
          <Carousel.Caption>
            <Row>
              <p>Welcome</p>
